...
We have actually included the touch screen setup in our [Assembly Guide](../assembly-guide/assembly). The only relevant instructions here is to install the on-screen keyboard. That said, this tutorial will still be kept here in case you wish to set-up the touchscreen before you assemble the case.
